(() => {
  ...
  var triBeige = document.getElementById("tri-beige");
  var triBlue = document.getElementById("tri-blue");
  var triPink = document.getElementById("tri-pink");
  var isMobile = window.matchMedia("(pointer: coarse)").matches;
  var logoR = logo.offsetWidth / 2;
  var MOBILE_REST = {
  ...
  var pinSections = Array.from(document.querySelectorAll("section")).filter((s) => s.id && s.id.startsWith("section"));
